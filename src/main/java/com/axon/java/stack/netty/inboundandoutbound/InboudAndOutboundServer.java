 ...
 */
public class InboudAndOutboundServer {
            ...
            serverBootstrap.group(bossGroup, workGroup)
                    ...
                    .childHandler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel socketChannel) throws Exception {
                            ...
                            pipeline//.addLast(new ByteToLongDecoderDemo())  // 加入解码器
                                    .addLast(new ReplayingDecoderDemo())
                                    .addLast(new ByteToLongEncorderDemo())
                                    .addLast(new InboudAndOutboundServerHandler()); // 加入编码器
                        }
                    });
